...
<head>
    ...
    <div class=\"container\">
        <div class=\"header\">
            <h1>環境許可データテーブル</h1>
            <p>太陽光発電施設に関する条例・許可情報（利害関係者確認コード）</p>
        </div>
        <div class=\"controls\">
    ...
    with csv_path.open('r', encoding='utf-8') as f:
        ...
        for r in reader:
            rows.append({
                ...
                'text': r.get('text'),
                'code': '*CLAUSE_STAKEHOLDER_CONFIRMATION',
...
if __name__ == '__main__':
    in_csv = Path('clause-viewer/stakeholder_confirmation_paragraphs.csv')
    out_html = Path('clause-viewer/stakeholder_confirmation_paragraphs.html')
